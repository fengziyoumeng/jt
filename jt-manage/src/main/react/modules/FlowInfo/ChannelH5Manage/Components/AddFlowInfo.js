                            ...
                            <Row>
                                <Col span="12">
                                    <FormItem  {...formItemLayout} label="产品名称：">
                                        <Input disabled={!props.canEdit}  {...getFieldProps('pname',{ rules: [{required:true,message:'必填'}]})} type="text"  />
                                    </FormItem>
                                </Col>
                                <Col span="12">
                            ...
                            <Row>
                                <Col span="12">
                                    <FormItem  {...formItemLayout} label="访问地址：">
                                        <Input disabled={!props.canEdit}  {...getFieldProps('phttp',{ rules: [{required:true,message:'必填'}]})} type="text"  />
                                    </FormItem>
                                </Col>
                            ...
                            <Row>
                                <Col span="12">
                                    <FormItem  {...formItemLayout} label="排序号：">
                                        <Input disabled={!props.canEdit}  {...getFieldProps('psort',{ rules: [{required:true,message:'必填'}]})} type="text"  />
                                    </FormItem>
                                </Col>
                                <Col span="12">
                        ...
                        <Row>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="申请人数：">
                                    <Input disabled={!props.canEdit}  {...getFieldProps('pBorrowNum',{ rules: [{required:true,message:'必填'}]})} type="text"  />
                                </FormItem>
                            </Col>
                            <Col span="12">
                        ...
                        <Row>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="标记（填一个字符）：">
                                    <Input disabled={!props.canEdit}  {...getFieldProps('pmarks')}  type="text"/>
                                </FormItem>
                            </Col>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="营销信息：">
                                    <Input disabled={!props.canEdit}  {...getFieldProps('pmessage')}  type="text"/>
                                </FormItem>
                            </Col>
                        </Row>
                        ...
                        <Row>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="贷款金额：">
                                    <Input min="0" type="number" style={{ width: 80, textAlign: 'center' }} placeholder="最小额度" {...getFieldProps('minLimit',{ rules: [{required:true,message:'必填'}]})}/>
                            ...
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="贷款期限：">
                                    <Input min="0" type="number" style={{ width: 80, textAlign: 'center' }} placeholder="最短时间" {...getFieldProps('minDay',{ rules: [{required:true,message:'必填'}]})}/>
                                    <Input style={{ width: 31, borderLeft: 0, pointerEvents: 'none', backgroundColor: '#fff', textAlign: 'center' }} placeholder="~" disabled />
                                    <Input min="0" type="number" style={{ width: 80, textAlign: 'center', borderLeft: 0 }} placeholder="最长时间" {...getFieldProps('maxDay')}/>
                        ...
                        <Row>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="放款时间：">
                                    <Input min="0" type="number" style={{ width: 80, textAlign: 'center' }} placeholder="最快时间" {...getFieldProps('ploanMinTime',{ rules: [{required:true,message:'必填'}]})}/>
                                    <Input style={{ width: 31, borderLeft: 0, pointerEvents: 'none', backgroundColor: '#fff', textAlign: 'center' }} placeholder="~" disabled />
                                    <Input min="0" type="number" style={{ width: 80, textAlign: 'center', borderLeft: 0 }} placeholder="最慢时间" {...getFieldProps('ploanMaxTime')}/>
                            ...
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="日利率：">
                                    <Input min="0" disabled={!props.canEdit}  {...getFieldProps('pinterest')}  type="number"/>
                                </FormItem>
                            </Col>
                        </Row>
                        <Row>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="产品标签:">
                                    <Select disabled={!props.canEdit}  multiple  {...getFieldProps('ptag', { rules: [{required:true,message:'必填',type:'array'}]}) } >
                                        {this.getTagList()}
                                    </Select>
                                </FormItem>
                            </Col>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="渠道洽谈价格（元）：">
                                    <Input min="0" disabled={!props.canEdit}  {...getFieldProps('pChannelPrice', { rules: [{required:true,message:'必填'}]})}  type="number"/>
                                </FormItem>
                            </Col>
                        </Row>
                        <Row>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="录入人信息：">
                                    <Input disabled={!props.canEdit}  {...getFieldProps('pHandPerson',{ rules: [{required:true,message:'必填'}]})} type="text"  />
                                </FormItem>
                            </Col>
                        </Row>
                    </div>
                        ...
                        <Row>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="申请条件：">
                                    <Input disabled={!props.canEdit}  {...getFieldProps('pcondition',{ rules: [{required:true,message:'必填'}]})} type="text"  />
                                </FormItem>
                            </Col>
                        ...
                        <Row>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="申请流程：">
                                    <Select disabled={!props.canEdit}  multiple  {...getFieldProps('pprocess', { rules: [{required:true,message:'必填',type:'array'}]})} >
                                        {this.getProcessList()}
                                    </Select>
                                </FormItem>
                            </Col>
                        ...
                        <Row>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="产品说明：">
                                    <Input disabled={!props.canEdit}  {...getFieldProps('premark',{ rules: [{required:true,message:'必填'}]})} type="text"  />
                                </FormItem>
                            </Col>
                        </Row>
                    </div>
