...
public class Constant {
	...
	public static final String RESPONSE_CONNECT = "id";

	public static final String RESPONSE_SORT = "sort";
	...
	public static final int ALREADY_EXIST_CODE = 10;
	...
	public static final String H5_MOBILE_TYPE = "3"; //H5判断标识

	public static final String MOBILE_TYPE_NO_LOGIN = "MTNL"; //注册后登录不登录标识
